 ...
 */
class NonBlockingHttpResponsekHandler implements JniHttpCallbackHandler {
    ...
    public NonBlockingHttpResponsekHandler(HttpRequest request, CompletableFuture<HttpResponse> responseHandler) throws IOException {
...
//            System.err.println("NonBlockingHttpResponsekHandler.onResponseComplete(): err_code: " + errorCode);
        try {
...
//            System.err.println("NonBlockingHttpResponsekHandler.sendOutgoingBody()");
